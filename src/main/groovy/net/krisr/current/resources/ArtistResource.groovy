...
import net.krisr.current.client.ArtistSearchRequest
...
class ArtistResource {
    ...
    @Timed
    @Path('/search')
    List<Artist> searchArtists(@Valid ArtistSearchRequest request) {
        return [artistModule.findByName(request.name)]
    }
